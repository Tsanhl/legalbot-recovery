...
ABSOLUTE_CONTEXT_CAP = 16384
ABSOLUTE_OUTPUT_CAP = 4096
ABSOLUTE_PREFILL_CAP = 1024
# Qwen3.5-9B keeps a KV cache on only 8 of 32 layers; 16k tokens at 8-bit
# KV is about 0.27 GB, so the larger window is safe on a 16 GB host.
