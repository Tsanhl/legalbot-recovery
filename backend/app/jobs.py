...
# Local Qwen 9B drafts up to 3,072 tokens after a 16k-token prefill, then runs
# per-claim review and up to two repairs; 900 s ended jobs before release.
ANSWER_WORKFLOW_SECONDS = 2_700
ANSWER_STAGE_SECONDS = 600
ANSWER_MODEL_CALL_SECONDS = 600
...
TERMINAL_INDETERMINATE_MODEL_CALL = "indeterminate_model_call_after_lease_loss"
